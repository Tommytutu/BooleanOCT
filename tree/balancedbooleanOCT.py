# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 22:09:47 2023
...
class balancedbooleanoptimalDecisionTreeClassifier:
    """
    ...
    def _buildMIP(self, x, y):
        ...
        # objective function
        error=0.5*(FN/sum(y) + FP/(self.n - sum(y)))
        ...
        #m.addConstr(f1*(2* sum(y)+FP-FN)<=2*(sum(y) -FN))
